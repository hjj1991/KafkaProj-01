...
public class FileAppendProducer {
    ...
    static final private Logger logger = LoggerFactory.getLogger(FileAppendProducer.class);
    ...
    public static void main(String[] args) {
        ...
        File file = new File("D:\\Study\\IntelliJ\\KafkaProj-01\\practice\\src\\main\\resources\\pizza_append.txt");
